 ...
 */
public class EndcExternalAnnotator extends ExternalAnnotator<PsiFile, List<EndcExternalAnnotator.Issue>> {
	...
	public List<Issue> doAnnotate( final PsiFile file ) {
		...
		Collection<? extends PsiElement> funcCallNameNodes =
			XPath.findAll(EndcLanguage.INSTANCE, file, "//call_expr/ID");
